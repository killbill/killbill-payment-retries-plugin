...
public class PaymentRetriesConfigurationHandler extends PluginTenantConfigurableConfigurationHandler<PaymentRetriesConfiguration> {
    ...
    public PaymentRetriesConfigurationHandler(final String pluginName, final OSGIKillbillAPI osgiKillbillAPI, final OSGIKillbillLogService osgiKillbillLogService) {
        super(pluginName, osgiKillbillAPI, osgiKillbillLogService);
    }

    @Override
    public PaymentRetriesConfiguration createConfigurable(final Properties properties) {
