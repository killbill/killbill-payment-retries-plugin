...
public enum ChasePaymentechAuthorizationDeclineCode implements AuthorizationDeclineCode {
    ...
    INVALID_ISSUE_NUMBER(252, "Invalid Issue Number", ErrorMessage.CARD_NUMBER_MISMATCH, true),
    ...
    FLOOR_LOW_FRAUD(332, "Floor Low Fraud", ErrorMessage.FRAUD, true),
    FLOOR_MEDIUM_FRAUD(333, "Floor Medium Fraud", ErrorMessage.FRAUD, true),
    FLOOR_HIGH_FRAUD(334, "Floor High fraud", ErrorMessage.FRAUD, false),
    FLOOR_UNAVAILABLE_FRAUD(335, "Floor Unavailable Fraud", ErrorMessage.FRAUD, true),
    CALL_REFER_TO_CARD_ISSUER(401, "Call/Refer to Card Issuer", true),
    DEFAULT_CALL(402, "Default Call", true),
    CALL_LOW_FRAUD(432, "Call Low Fraud", ErrorMessage.FRAUD, true),
    CALL_MEDIUM_FRAUD(433, "Call Medium Fraud", ErrorMessage.FRAUD, true),
    CALL_HIGH_FRAUD(434, "Call High Fraud", ErrorMessage.FRAUD, false),
    CALL_UNAVAILABLE_FRAUD(435, "Call Unavailable Fraud", ErrorMessage.FRAUD, true),
    DEFAULT_CALL_LOW_FRAUD(442, "Default Call Low Fraud", ErrorMessage.FRAUD, true),
    DEFAULT_CALL_MEDIUM_FRAUD(443, "Default Call Medium Fraud", ErrorMessage.FRAUD, true),
    DEFAULT_CALL_HIGH_FRAUD(444, "Default Call High Fraud", ErrorMessage.FRAUD, false),
    DEFAULT_CALL_UNAVAILABLE_FRAUD(445, "Default Call Unavailable Fraud", ErrorMessage.FRAUD, true),
    PICKUP(501, "Pickup", false),
    LOST_STOLEN(502, "Lost/Stolen", ErrorMessage.LOST_OR_STOLEN, false),
    FRAUD(503, "Fraud", ErrorMessage.FRAUD, true),
    ...
    INSUFFICIENT_FUNDS(521, "Insufficient Funds", ErrorMessage.INSUFFICIENT_FUNDS, true),
    CARD_IS_EXPIRED(522, "Card is Expired", ErrorMessage.EXPIRED_CARD, false),
    ENCRYPTED_DATA_BAD(523, "Encrypted Data Bad", true),
    ALTERED_DATA(524, "Altered Data", true),
    DO_NOT_HONOR(530, "Do Not Honor", true),
    CVV2_CVC2_FAILURE(531, "CVV2/CVC2 Failure", ErrorMessage.CVV_MISMATCH, true),
    DO_NOT_HONOR_LOW_FRAUD(532, "Do Not Honor Low Fraud", ErrorMessage.FRAUD, true),
    DO_NOT_HONOR_MEDIUM_FRAUD(533, "Do Not Honor Medium Fraud", ErrorMessage.FRAUD, true),
    DO_NOT_HONOR_HIGH_FRAUD(534, "Do Not Honor High fraud", false),
    DO_NOT_HONOR_UNAVAILABLE_FRAUD(535, "Do Not Honor Unavailable Fraud", ErrorMessage.FRAUD, true),
    ...
    ADDRESS_VERIFICATION_FAILED(547, "Address Verification Failed", ErrorMessage.ADDRESS_MISMATCH, true),
    ...
    INVALID_CREDIT_CARD_NUMBER(591, "Invalid Credit Card Number", ErrorMessage.CARD_NUMBER_MISMATCH, false),
    BAD_AMOUNT_2(592, "Bad Amount", true),
    OTHER_ERROR_2(594, "Other Error", true),
    NEW_CARD_ISSUED(595, "New Card Issued", false),
    ISSUER_HAS_FLAGGED_ACCOUNT_AS_SUSPECTED_FRAUD(596, "Issuer has Flagged Account as Suspected Fraud. (Discover Only)", ErrorMessage.FRAUD, false),
    ...
    INVALID_EXPIRATION_DATE(605, "Invalid Expiration Date", ErrorMessage.EXPIRATION_DATE_MISMATCH, true),
    ...
    NO_ADDRESS(762, "No Address", ErrorMessage.ADDRESS_MISMATCH, true),
    INVALID_ACCOUNT_NUMBER(763, "Invalid Account Number", ErrorMessage.CARD_NUMBER_MISMATCH, true),
    ...
    BAD_ACCOUNT_NUMBER_DATA(768, "Bad Account Number Data", ErrorMessage.CARD_NUMBER_MISMATCH, true),
    ...
    INVALID_EXPIRATION(903, "Invalid Expiration", ErrorMessage.EXPIRATION_DATE_MISMATCH, true),
